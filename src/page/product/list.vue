<template>
    <div class="product-list">
        ...
        <div v-for="(commodity,i) in products" :key="i">
          <commodity-card :commodity='commodity' @click="showProduct(commodity)" />
        </div>
    </div>
</template>
    ...
    return {
      ...
      filtershow: false,
            products:[
                {
                    id:1,
                    thumb:'https://pop.nosdn.127.net/19e33c9b-6c22-4a4b-96da-1cb7afb32712',
                    commodityTitle:'BEYOND博洋家纺 床上套件 秋冬保暖纯棉床单被套 双人被罩 磨毛全棉印花床品四件套',
                    sellPrice:'13.00',
                },
                {
                    id:1,
